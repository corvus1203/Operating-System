...
(C.1) faber_fs_thread_test (3 out of 3 pts)
    What is your kshell command to invoke faber_fs_thread_test(): faberfs n (n is 2, 3, ...etc)
(C.2) faber_directory_test (2 out of 2 pts)
    What is your kshell command to invoke faber_directory_test(): faberdir n (n is 10, 20, ...etc)

(D) Self-checks: (10 out of 10 pts)
    Please provide details, add subsections and/or items as needed; or, say that "none is needed".
    Details: please use the command to invoke self-checks tests : selftest2
...
1)  Names and USC e-mail addresses of team members: 
    Ho-Chia Chen: 	hochiach@usc.edu
    Yun-Tang Hsu: 	yuntangh@usc.edu
    Yuantao Zhang:	yuantaoz@usc.edu
    Feibi Liu: 		feibiliu@usc.edu
